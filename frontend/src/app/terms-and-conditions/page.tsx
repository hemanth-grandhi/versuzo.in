      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="prose prose-brand max-w-none space-y-8 text-sm leading-relaxed text-brand-700 dark:prose-invert dark:text-brand-300 md:text-base">
          <section className="space-y-3">
            ...
            <p>
              By accessing and navigating the website at{" "}
              <a
                href="https://versuzo.in"
                className="text-sky-500 hover:underline"
              >
                versuzo.in
              </a>
              , you agree to comply with all applicable local, national, and
              international laws. Access is permitted on a temporary,
              non-transferable basis, and we reserve the right to suspend or
          ...
          <section className="space-y-3">
            ...
            <p>As a user, you agree that you will not:</p>
          ...
          <section className="space-y-3">
            ...
            <p>
              All materials hosted on Versuzo - including cohort videos,
              project code repositories, curriculums, logos, articles, designs,
              and text - are owned by or licensed to Versuzo and are protected
              by international copyright and trademark laws. Unauthorized
              reproduction, resale, or distribution of this content is strictly
              prohibited.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Upon registration and successful enrollment, we grant you a
              personal, non-transferable, revocable license to access our online
              materials, join live sessions, and submit practical assignments.
              This license is granted solely for your individual professional
          ...
          <section className="space-y-3">
            ...
            <p>
              You must guard your credentials diligently and prevent third-party
              access to your student account dashboard. Account credentials may
              not be shared, and we reserve the right to terminate access
              immediately without liability if shared credentials or
              unauthorized login sessions are detected.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              The learning materials and practical projects on our platform are
              provided on an &apos;as is&apos; basis. While we connect you with
              industry leaders and offer extensive career placement support,
              Versuzo holds no liability for specific career advancement
              milestones, external academic accreditation equivalence, or
              indirect damages arising from the use of our services.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              any disputes, claims, or actions relating to the services will be
