...
import { User, Lock, Mail, AlertTriangle, Loader } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-8 relative z-10">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-brand-600 dark:text-brand-400">
            Sign up to get access to cohort learning and projects
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-brand-100/80 bg-white/70 p-6 shadow-2xl backdrop-blur-md dark:border-brand-900/60 dark:bg-brand-950/70 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs font-bold text-brand-700 dark:text-brand-300 uppercase tracking-wider mb-2">
                Full Name
              </label>
